...
# Accuracy:
The accuracy of this model that I developed gets around 3000 dollars off of the actual car price, the mse is around 4 million. I did this by using hyperparameters to train the model and things like early stopping which stops the epoches early when the model stops improving.
